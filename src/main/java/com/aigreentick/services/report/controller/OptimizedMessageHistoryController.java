...
import com.aigreentick.services.report.service.OptimizedMessageHistoryService;
...
@Slf4j
public class OptimizedMessageHistoryController {

    private final OptimizedMessageHistoryService service;
    ...
    public ResponseEntity<MessageHistoryWrapperResponse> getMessagesHistory(
        ...
        log.info("=== GET /api/v1/get-messages-history - userId: {}, page: {}, perPage: {} ===",
                userId, page, perPage);
